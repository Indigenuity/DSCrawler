...
public class DealerCrawlConfig extends CrawlConfig {
	...
	protected final static String DEFAULT_USER_AGENT_STRING = Global.getDefaultUserAgentString();
	protected final static String DEFAULT_CRAWL_STORAGE_ROOT = Global.getCrawlStorageFolder();  
